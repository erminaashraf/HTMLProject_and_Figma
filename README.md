# HTMLProject_and_Figma
This repository contains my MGCR 331 – HTML Project, a two-page website designed and coded using HTML and CSS.
...
- A sidebar with external resources and a contact form built with labelled inputs, checkboxes, and buttons

- A colour palette and layout derived from Figma prototypes, following design principles taught in the course
